...
// get the viewer as a pug for rendering pug files
...
app.get('/', (req, res) =>{
  ...
  // It does not need any path file because render function
  // has that inside of it. Function will find pug file 
